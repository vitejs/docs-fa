...
::: tip نکته سازگاری
Vite به نسخه ۱۸+ یا ۲۰+ از [Node.js](https://nodejs.org/en/) نیاز دارد. با این حال، برخی قالب‌ها برای کار نیاز به نسخه بالاتری از Node.js دارند. لطفاً اگر پکیج منیحر شما هشدار می‌دهد، آن را به‌روزرسانی کنید.
:::
